...
**Nhược điểm:** Mỗi ALB ~$22/tháng. 10 services = $220/tháng chỉ cho internal LBs. Có thể share 1 ALB cho nhiều services bằng path routing, nhưng sẽ coupling routing rules.

**Recommend:** Dùng **1 shared Internal ALB** cho tất cả services, routing bằng path hoặc host-based rules. Chỉ tách ALB riêng khi cần isolate (VD: Payment service).
