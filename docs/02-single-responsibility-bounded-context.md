...
- Tiếp theo: [Decomposition Strategies](03-decomposition-strategies.md) — Chiến lược cụ thể để phân tách service
- [Data Management](07-data-management.md) — Database per Service, Saga pattern
- [Inter-Service Communication](04-inter-service-communication.md) — Cách các service giao tiếp
- [Design Patterns tổng hợp](14-design-patterns.md) — Anti-corruption Layer, Strangler Fig và các pattern khác
